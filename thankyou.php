...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v6.0&appId=138232436268573&autoLogAppEvents=1"></script>
		...
		<!-- Banner -->
			<section id="banner">
                ...
                <?PHP
					include 'menu1.php';
				?>
                <p style="color:#FFCC00">Welcome <b style="color:#FFCC00"><?php echo $_SESSION['FNAME'];?> </b> - Date: <?php echo date('Y-m-d'); ?> </p>
    ...
    <p align="center" class="style2">Your Selected Requirements have been SAVED!</p>

 				<p align="center"><img src="images/thanks.jpg" width="800"  align="middle"></p>
